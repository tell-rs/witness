...
/// Offset state file path (systemd StateDirectory=tell-agent creates this dir).
const STATE_FILE: &str = "/var/lib/tell-agent/offsets";
...
/// Emit a complete line, prepending any buffered partial.
